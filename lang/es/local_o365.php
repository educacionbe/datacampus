...
/**
 * Strings for component 'local_o365', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   local_o365
...
$string['settings_creategroups_details'] = 'Si se activa, se creará y mantendrá un grupo de profesores y alumnos en Office365 para cada curso existente en Moodle. Con cada ejecución del Cron se crearán y actualizarán los grupos  (y se añadirán todos los miembros actuales). La pertenencia al grupo de Office365 se mantendrá mediante la gestión de matrícula  de los usuarios en el curso de Moodle. <br /><b>Nota: </b>Esta funcionalidad requiere Office365 unified API agregada a la aplicación añadida en Azure. <a href="https://docs.moodle.org/27/en/Office365#User_groups">Instrucciones de instalación y documentación.</a>';
...
$string['ucp_onenote_desc'] = 'En esta página podrá configurar las opciones para Office365 OneNote.';
$string['ucp_onenote_disable'] = 'Inhabilitar Office365 OneNote';
