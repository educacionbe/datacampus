...
/**
 * Strings for component 'message', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   message
...
$string['beepnewmessage'] = '\'Beep\' cuando se muestre una ventana emergente de notificación';
...
$string['contactlistempty'] = 'Lista de contactos vacía';
...
$string['errorwhilesendingmessage'] = 'Ha ocurrido un error mientras se enviaba este mensaje, por favor inténtelo de nuevo más tarde.';
...
$string['unabletomessageuser'] = 'No está habilitado para enviar un mensaje a ese usuario';
