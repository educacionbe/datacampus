...
/**
 * Strings for component 'enrol_ldap', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   enrol_ldap
...
$string['course_shortname_updateonsync'] = 'Actualizar nombre corto durante el script de sincronización';
