...
/**
 * Strings for component 'grades', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   grades
...
$string['aggregatesonly'] = 'Cambiar a sólo cálculos totales';
...
$string['errorupdatinggradecategoryaggregateoutcomes'] = 'Error al actualizar el ajuste "Incluir los resultados en la agregación" de la categoría de calificación ID {$a->id}';
...
$string['gradepointdefault_help'] = 'Este ajuste determina el valor predeterminado para la puntuación máxima diponible en una actividad.';
...
$string['upgradedgradeshidemessage'] = 'Descartar aviso';
