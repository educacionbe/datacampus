...
/**
 * Strings for component 'block_graph_stats', language 'es', branch 'MOODLE_29_STABLE'
 *
...
$string['inner_background'] = 'Fondo de la gráfica';
...
$string['outer_background_help'] = 'Color de fondo';
$string['pluginname'] = 'Esatadísticas';
$string['style'] = 'Diseño';
$string['style_help'] = 'Diseño de la gráfica';
$string['uniquevisitors'] = 'Visitas únicas';
$string['visitors'] = 'Visitas';
