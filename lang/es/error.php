...
/**
 * Strings for component 'error', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   error
...
$string['cannotservefile'] = 'No se puede servir el fichero - problema de configuración del servidor.';
...
$string['invalidshortname'] = 'Esto es un nombre corto de curso no válido';
...
$string['maxbytes'] = 'El fichero es más grande que el máximo tamaño permitido.';
...
$string['nopermissiontodelentry'] = '¡No puede borrar las entradas de otras personas!';
...
$string['nopermissiontoupdatecalendar'] = 'Lo siento, pero actualmente no tiene permisos para actualizar eventos del calendario';
...
$string['usernotdeletedadmin'] = 'Usuario no borrado - no se puede borrar la cuenta del administrador';
